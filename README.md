...
Рекомендуется использовать вариант с 64-битным кодом, т.к. он оптимизируется компилятором и не занимает места в оперативной памяти! В библиотеке есть также инструмент для наглядного создания 64-бит иконок прямо в программе:

```cpp
uint64_t smile = glcd::glyph64(
    0b00000,
    0b00000,
    0b01010,
    0b01010,
